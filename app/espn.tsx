...
export async function getTeamData(teamId: string): Promise<TeamData> {
	...
	const res = await fetch(`https://site.api.espn.com/apis/site/v2/sports/football/college-football/teams/${teamId}/schedule`);
...
export async function getAllTeamIds(): Promise<TeamBasicInfo[]> {
	const pagePromises = Array.from({ length: 8 }, (_, i) =>
		fetch(`https://site.api.espn.com/apis/site/v2/sports/football/college-football/teams?page=${i + 1}`).then((res) => {
			if (!res.ok) {
...
export async function getTodaySchedule() {
	const res = await fetch("https://site.web.api.espn.com/apis/site/v2/sports/football/college-football/scoreboard");
...
export async function getConferenceRankings(): Promise<ConferenceRankingEntry[]> {
	const res = await fetch(
		"https://site.web.api.espn.com/apis/v2/sports/football/college-football/standings?region=us&lang=en&contentorigin=espn&group=8&season=2024"
	);
